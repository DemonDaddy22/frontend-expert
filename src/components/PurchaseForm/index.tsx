  ...
  return (
    <ProjectPage title={title}>
      <QuestionDetails title={title} titleClassName={classes.questionTitle} containerClassName={classes.questionDetails}>
        ...
        <ul>
          <li>
            The <span className={classes.questionDescriptionHighlight}>.wrapper</span> should have 12px of padding, a border radius of 12px, and a
          ...
          <li>
            ...
            <ul>
              <li>This stepper should be horizontally centered with no padding, but it should maintain its default vertical margin.</li>
              <li>
                Each list item in the stepper should have its corresponding item number above its text content, and this number should be inside of a
                circle with a white
                ...
                horizontally and vertically centered, and the circle should be horizontally centered above the text content.
              </li>
              <li>
                The number-circle for the list item with the <span className={classes.questionDescriptionHighlight}>selected</span> class should have
                white
                <ColourBlock colour={COLORS.WHITE} />
              ...
              <li>
                Between each pair of adjacent number-circles should be a 4px-tall black horizontal line. These divider lines should be vertically
                centered with respect to the number-circles, and they should sit exactly between the circles, just touching their edges.
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                Each list item in the unordered list represents a single product offering and should have 12px of padding, 12px of vertical margin, a
                height of 40px, a border-radius of 8px, bold font, and a white
                <ColourBlock colour={COLORS.WHITE} />
                background color.
              </li>
              <li>
              ...
              <li>Each product-offering list item should also have a solid, 5px left border of the same color as its text.</li>
            </ul>
          </li>
          <li>
            The "Continue" button should be aligned to the right side of the <span className={classes.questionDescriptionHighlight}>.wrapper</span>,
            with 12px of padding, a font-size of 16px, a border radius of 8px, a background color of #02203C
            <ColourBlock colour={COLORS.BLUE1} className={classes.colorBlockBorder} />
            and a white
            <ColourBlock colour={COLORS.WHITE} />
            text color. For convenience, the starting code includes variables with most of the specified pixel values and colors.
          </li>
        </ul>
      </QuestionDetails>
      <Divider />
