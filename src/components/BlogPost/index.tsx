    ...
    <ProjectPage>
      <QuestionDetails title='Blog Post' titleClassName={classes.questionTitle}>
        ...
        <p>
          ...
          of <span className={classes.questionDescriptionHighlight}>The future of decentralized meme currency is here</span>.
        </p>
        <p>
          ...
          <span className={classes.questionDescriptionHighlight}>Where Do I Start?</span>, respectively. Each section should have a paragraph of text
          (the text directly below the respective section title in the starting code), and the sections should be divided by a horizontal rule.
        </p>
        <p>
      ...
      <article className={classes.blogContainer}>
        ...
        <section className={classes.blogSection}>
          ...
          <p className={classes.blogSectionContent}>
            AlgoCoin utilizes a revolutionary <strong>proof-of-inverted-binary-tree consensus algorithm</strong> that will absolutely transform the
            way we think about currency and catapult the metaverse to its next major stage: <em>Web 4.0</em>. Using AlgoCoin is simple. Instead of
            hoarding capital in wallets with forgotten passwords, earn AlgoCoin at the time of usage through our unique point-of-sale system. Each
            inverted binary tree equates to one AlgoCoin. This means if your chicken tenders cost 420 AlgoCoin, all you need to do is invert 420
            binary trees.
          </p>
        </section>
        <Divider />
        <section className={classes.blogSection}>
          ...
          <p className={classes.blogSectionContent}>
            Getting started with AlgoCoin is as easy as reversing a linked list. We recommend starting out by practicing on{' '}
            <a className={classes.blogLink} target='__blank' href='https://algoexpert.io'>
              AlgoExpert
            </a>
            . Next, once you feel you can invert binary trees as well as an Ex-FAANG 10x engineer, it's time to ditch your fiat currency and enter the
            future.
          </p>
        </section>
